...
[9] = LAYOUT_planck_grid(
      KC_TAB,   _______,   _______,   _______,  _______,    _______,        _______,  _______,    KC_MS_U,    _______,    KC_WH_D,    _______,  
      TG(9),    KC_A,      KC_S,      KC_BTN2,  KC_BTN1,    _______,        _______,  KC_MS_L,    KC_MS_D,    KC_MS_R,    KC_WH_U,    _______,  
